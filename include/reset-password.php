...
if(isset($_POST['submit'])){
	...
	if($check==0){
		...
		$mailHtml='Hi, '.$row['fullname'].' Please confirm your account registration by clicking the button or link below: <a href="https://'.$parse['host'].'/include/check.php?id='.$verification_id.'">https://rimo.dwri.gov.np/include/check.php?id='.$verification_id.'</a>';
...
<div class="signup-form">
	...
	<div class="text-center">If you have password <a style="color: #00eb48;"  href="../index.php">Login</a></div>
</div>
</body>
</html>                            