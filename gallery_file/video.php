...
<link href="../favicon.png" rel="icon">
    ...
    <title>Gallery Video-RIMO</title>
</head>
...
?>
    ...
    <div class="sub-menu-header">
        <ul>
            ...
            <li><a href="#"><?=$gallery[$language][1]?>  </a></li>
                ...
                <div>
                    <div class="gallery-container">
                        ...
                        <div class="photo-gallery">
                            ...
                            <?php
                                 $sql = "SELECT * FROM `video`ORDER BY video_id DESC LIMIT $show_page,$post_per_page";
                                 ...
                                 while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="button">
                                        ...
                                        <a href="<?= $row['url']?>" style="color: #fff;">Watch this</a>
                                        </div>
                                    </div>
                                </div>
