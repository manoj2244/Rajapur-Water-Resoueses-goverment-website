...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `khairi` WHERE `id` = $sno";
...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  if (isset( $_POST['snoEdit'])){
    ...
    $sql="UPDATE `khairi` SET `content_heading` = '$title' WHERE `khairi`.`id` = $news_id;";
  ...
  $sql="INSERT INTO `khairi` (`content_heading`) VALUES ('$title')";
...
?>
  ...
  ?>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">khairi</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <h2>Add Irrigation project khairi</h2>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `/admin/khairi.php?delete=${sno}`;
