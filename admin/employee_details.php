...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `employee_details` WHERE `card_id` = $sno";
...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  if (isset( $_POST['snoEdit'])){
    ...
    if($fileerror==0){
      ...
      $sql = "SELECT * FROM `employee_details` WHERE `card_id`=$news_id";
      $result = mysqli_query($db, $sql);
    ...
    $sql="UPDATE `employee_details` SET `name` = '$title',`profession`='$title1',`sereni`='$title2',`phone`='$title3', `kaifiyat`='$title4',`card_image` = '$destfile' WHERE `employee_details`.`card_id` = $news_id;";
  ...
  $sql="INSERT INTO `employee_details` (`name`, `profession`, `sereni`, `phone`,`kaifiyat`,`card_image`) VALUES ('$title', '$title1', '$title2', '$title3','$title4','$destfile')";
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">employee_details</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `/admin/employee_details.php?delete=${sno}`;
