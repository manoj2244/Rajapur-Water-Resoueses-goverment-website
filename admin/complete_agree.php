...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `complete_badkha` WHERE `table_id` = $sno";
...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  if (isset( $_POST['snoEdit'])){
   ...
   // $title5=mysqli_real_escape_string($db,$_POST['title5']);
    ...
    $sql="UPDATE `complete_badkha` SET `content_heading`='$title',`name_of_project`='$title1',`name_of_work`='$title2',`Contracts identification numbers`='$title3',`Names ands addresss of contractor`='$title4',`Dates of agreement`='$title6',`Amount of Agreement`='$title7',`Dates of completion`='$title8',`Actual Expenditure`='$title9',`Contractors`='$title10',`Current statuss`='$title11',`Major works completed`='$title12' WHERE `complete_badkha`.`table_id` = $news_id;";
 ...
 // $title5=mysqli_real_escape_string($db,$_POST['title5']);
  ...
  $sql="INSERT INTO `complete_badkha` (`content_heading`,`name_of_project`, `name_of_work`, `Contracts identification numbers`, `Names ands addresss of contractor`, `Dates of agreement`, `Amount of Agreement`, `Dates of completion`, `Actual Expenditure`, `Contractors`, `Current statuss`, `Major works completed`) VALUES ('$title', '$title1', '$title2', '$title3', '$title4', '$title6', '$title7', '$title8', '$title9', '$title10', '$title11', '$title12')";
...
?>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">complete agreement</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="container my-4">
    ...
    <table class="table" id="myTable">
      ...
      <tbody>
        <?php 
          $sql = "SELECT * FROM `complete_badkha`";
          $result = mysqli_query($db, $sql);
          $sno = 0;
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `/admin/complete_agree.php?delete=${sno}`;
