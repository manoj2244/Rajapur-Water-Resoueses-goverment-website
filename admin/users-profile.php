...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  $sql="UPDATE `login` SET `image` = '$destfile', `fullname` = '$fullname',`email`='$email' WHERE `login`.`id` = 1;";
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <h5 class="card-title">About</h5>
                    <p class="small fst-italic">यो कार्यालय (साबिक बबइ राजापुर सिंचाइ व्यवस्थापन डिभिजन हाल राजापुर सिंचाइ व्यवस्थापन कार्यालय) उर्जा, जलश्रोत
                              ...
                              विविधिकरणमा जोड दिदै बालीको उत्पादकत्व वृद्धि गरी कृषकको जीवनस्तरमा सुधार गर्नु रहेको छ ।</p>
            ...
            $row = @mysqli_fetch_assoc($result)
                ...
                ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?=$row['location']?></div>
                  </div>
    ...
    ?>
                  <form method="POST" enctype="multipart/form-data" action=""> 
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px">यो कार्यालय (साबिक बबइ राजापुर सिंचाइ व्यवस्थापन डिभिजन हाल राजापुर सिंचाइ व्यवस्थापन कार्यालय) उर्जा, जलश्रोत तथा सिंचाइ मन्त्रालय मातहतको जलस्रोत तथा सिंचाइ विभाग अन्तर्गत रहेको छ । यो कार्यालयको स्थापनाको मुख्य उद्देश्य भनेको राजापुर सिंचाइ प्रणाली (14880 हे.) को सम्पूर्ण कमाण्ड क्षेत्रमा बर्षैभरी भरपर्दो सिंचाइ सुविधा उपलब्ध गराइ बाली विविधिकरणमा जोड दिदै बालीको उत्पादकत्व वृद्धि गरी कृषकको जीवनस्तरमा सुधार गर्नु रहेको छ ।</textarea>
                      </div>
                    </div>
