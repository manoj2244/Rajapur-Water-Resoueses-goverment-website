...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  $title2=mysqli_real_escape_string($db,$_POST['title2']);
    ...
    $sql="UPDATE `introduction` SET `background` = '$title', `objectives` = '$title1',`plan`='$title2' WHERE `introduction`.`id` = $news_id;";
  ...
  $sql="INSERT INTO `introduction` (`background`, `objectives`,`plan`) VALUES ('$title', '$title1','$title2')";
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          ...
          <th width="30%" scope="col">पृष्ठभूमि</th>
          <th width="20%" scope="col">उद्देश्य</th>
          <th width="20%" scope="col">योजना</th>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `/admin/background.php?delete=${sno}`;
