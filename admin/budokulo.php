...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `budokulo` WHERE `id` = $sno";
...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  if (isset( $_POST['snoEdit'])){
    ...
    $sql="UPDATE `budokulo` SET `content_heading` = '$title' WHERE `budokulo`.`id` = $news_id;";
  ...
  $sql="INSERT INTO `budokulo` (`content_heading`) VALUES ('$title')";
...
?>
  ...
  ?>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Budokulo</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <h2>Add Irrigation project Budokulo</h2>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `/admin/budokulo.php?delete=${sno}`;
